 ...
 */
public class Guide_pager3 extends Fragment{
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = View.inflate(getActivity(), R.layout.pager3,null);
        ImageView tv_jin = (ImageView)view.findViewById(R.id.iv_pager3);
